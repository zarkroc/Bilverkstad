...
/**
 * Class file to represent an garageshop objects. Stores vehicle objects in a list.
 * @author Tomas Perers
 ...
 *          of model year
 *          2016-12-11: Updated all prgram to use objects. Rearragned the whole code
 * 
 */
public class GarageShop {
    ...
    public void registerVehicle() {
        ...
        String regNumber = JOptionPane.showInputDialog("Ange registreringsnummer");
        String modelYear = JOptionPane.showInputDialog("Ange årsmodell");
        ...
        String brand = JOptionPane.showInputDialog("Ange märke");
