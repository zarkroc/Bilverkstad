...
/**
 * Program to register vehicles for repairs in a garageshop
 * program also lists and search for vehicles
 * 
 * @author Tomas Perers
...
public class Gui {
    /**
     * Creates a number of message boxes for the user to input information to register vehicles etc.
     * Also lists and search registered vehicles.
     * @param args 
     */
    public static void main(String[] args) {
        ...
        System.out.println("Owners registered in the garage");
